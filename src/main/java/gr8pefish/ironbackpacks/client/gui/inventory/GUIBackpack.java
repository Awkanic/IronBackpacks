...
public class GUIBackpack extends GuiContainer {
    ...
    protected void drawGuiContainerForegroundLayer(int mouseX, int mouseY) {
        ...
        if (itemStack != null)
            this.fontRendererObj.drawString(I18n.translateToLocal(itemStack.getDisplayName()), 20, 6, 4210752); //respects renamed backpacks this way
        else
            this.fontRendererObj.drawString(I18n.translateToLocal("misc.ironbackpacks.default.equpped.backpack.name"), 20, 6, 4210752); //default name, should ideally never be used

        this.fontRendererObj.drawString(I18n.translateToLocal("container.inventory"), 20, this.ySize - 96 + 2, 4210752);
