...
public class GUIBackpackAlternate extends GuiContainer {
    ...
    private void drawInfoStrings(){
        ...
        fontRendererObj.drawString(I18n.translateToLocal(displayName), 20, 6, 4210752);
        int counter = hasFilterAdvancedUpgrade ? 5 : 4;
        fontRendererObj.drawString(I18n.translateToLocal("container.inventory"), 20, ySize - 96 + counter, 4210752);

        //draw the titles of all the upgrades in their correct positions
        if (hasNoUpgrades)
            fontRendererObj.drawString(I18n.translateToLocal("gui.ironbackpacks.noValidUpgradesFound"), 20, 22, 4210752);
        int yStart = hasRenamingUpgrade ? 44 : 25;
        if (hasCraftingUpgrade) {
            fontRendererObj.drawString(I18n.translateToLocal("items.ironbackpacks.upgrade.recipes.name"),20, yStart, 4210752);
            yStart += 36;
        }
        if (hasCraftingSmallUpgrade) {
            fontRendererObj.drawString(I18n.translateToLocal("items.ironbackpacks.upgrade.craftingSmall.name"),20, yStart, 4210752);
            yStart += 36;
        }
        if (hasCraftingTinyUpgrade) {
            fontRendererObj.drawString(I18n.translateToLocal("items.ironbackpacks.upgrade.craftingTiny.name"),20, yStart, 4210752);
            yStart += 36;
        }
        if (hasFilterBasicUpgrade) {
            fontRendererObj.drawString(I18n.translateToLocal("items.ironbackpacks.upgrade.filterBasic.name"), 20, yStart, 4210752);
            yStart += 36;
        }
        if (hasFilterFuzzyUpgrade) {
            fontRendererObj.drawString(I18n.translateToLocal("items.ironbackpacks.upgrade.filterFuzzy.name"), 20, yStart, 4210752);
            yStart += 36;
        }
        if (hasFilterOreDictUpgrade) {
            fontRendererObj.drawString(I18n.translateToLocal("items.ironbackpacks.upgrade.filterOreDict.name"), 20, yStart, 4210752);
            yStart += 36;
        }
        if (hasFilterModSpecificUpgrade) {
            fontRendererObj.drawString(I18n.translateToLocal("items.ironbackpacks.upgrade.filterModSpecific.name"),20, yStart, 4210752);
            yStart += 36;
        }
        if (hasFilterVoidUpgrade) {
            fontRendererObj.drawString(I18n.translateToLocal("items.ironbackpacks.upgrade.filterVoid.name"),20, yStart, 4210752);
            yStart += 36;
        }
        if (hasFilterAdvancedUpgrade) {
            fontRendererObj.drawString(I18n.translateToLocal("items.ironbackpacks.upgrade.filterAdvanced.name"),20, yStart, 4210752);
            yStart += 36;
        }
        if (hasFilterMiningUpgrade) {
            fontRendererObj.drawString(I18n.translateToLocal("items.ironbackpacks.upgrade.filterMining.name"),20, yStart, 4210752);
            yStart += 36;
        }
        if (hasRestockingUpgrade) {
            fontRendererObj.drawString(I18n.translateToLocal("items.ironbackpacks.upgrade.restocking.name"),20, yStart, 4210752);
        }
